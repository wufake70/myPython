...
# print(server.accept()) print(conn)         # 返回链接信息（尖括号 代表 内存上Python对象） <socket.socket fd=440, family=AddressFamily.AF_INET, type=SocketKind.SOCK_STREAM, proto=0, laddr=('127.0.0.1', 8889), raddr=('127.0.0.1', 1385)> 
