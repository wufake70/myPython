    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['data']:
            ...
            try:
                ...
                # 保存图片
                #  路径解释：在当前文件夹下创建一个名叫word变量的文件夹，又在该文件夹内以数字命名文件
        ...
        while pn < self.__amount:
            ...
            try:
                ...
                if 'data' not in rsp_data:
                    #  print(rsp_data) 返回Forbid spider access ，禁止爬虫程序访问
                    print("触发了反爬机制，自动重试！")
                else:
                    # 保存图片
                    # 查看json数据
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        crawler.start('孙小伟', 10, 2, 30)  # 抓取关键词为 “美女”，总数为 1 页，开始页码为 2，每页30张（即总共 2*30=60 张）
